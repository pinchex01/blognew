                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ url('addPost') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="post_body" rows="7" type="post_body" class="form-control{{ $errors->has('post_body') ? ' is-invalid' : '' }}" name="post_body" value="{{ old('post_body') }}" required autofocus></textarea>
